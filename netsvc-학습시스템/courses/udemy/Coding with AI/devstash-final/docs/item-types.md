...
Icons are mapped via `ITEM_TYPE_ICONS` in **src/lib/constants/item-types.ts**:
...
- **prisma/seed.ts** - System type definitions
- **src/lib/constants/item-types.ts** - Icon/color mappings
